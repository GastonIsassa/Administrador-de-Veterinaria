...
class UI {
    ...
    imprimirAlerta(mensaje, tipo) {
        ...
        if(tipo === 'error') {
         ...
         // quitar el alerta despues de 5 seg
         setTimeout(() => {
            divMensaje.remove(); 
         }, 5000);
    }
    ...
    imprimirCitas({citas}) {
        ...
        citas.forEach(cita => {
            ...
            propietarioParrafo.innerHTML = `
                <span class="font-weigt-bolder">Propietario: </span> ${propietario}
            `;

            const telefonoParrafo = document.createElement('p');
            telefonoParrafo.innerHTML = `
                <span class="font-weigt-bolder">Telefono: </span> ${telefono}
            `;
            const fechaParrafo = document.createElement('p');
            fechaParrafo.innerHTML = `
                <span class="font-weigt-bolder">Fecha: </span> ${fecha}
            `;
            const horaParrafo = document.createElement('p');
            horaParrafo.innerHTML = `
                <span class="font-weigt-bolder">Hora: </span> ${hora}
            `;
            const sintomasParrafo = document.createElement('p');
            sintomasParrafo.innerHTML = `
                <span class="font-weigt-bolder">Sintomas: </span> ${sintomas}
            `;
